...
function PrintWeaponInfo(self,x,y,alpha)
	...
	if self.InfoMarkup == nil then
		...
		if self.Instructions ~= "" then str = str .. title_color .. "Purpose:</color>\t"..text_color..self.Instructions.."</color>\n" end
        if ( self.Purpose ~= "" ) then str = str .. title_color .. "Instruction:</color>\n"..text_color..self.Purpose.."</color>\n\n" end
		str = str .. "</font>"
	...
	draw.RoundedBox(4,x,y-2.5,260,self.InfoMarkup:GetHeight() + 5,Color(60,60,60,alpha))
