	...
	local NewConfig = {
		...
		RadioSpecs = {
			...
			AvailablePackages = {
				...
				["Квадрокоптер"] = {
					description = "Квадрокоптер с взрывпакетом",
					category = "Drons",
					results = {"dronesrewrite_camera", 2}
				},
		...
		Craftables = {
			...
			["EZ Nano Nuclear Bomb"] = {
				...
				craftingReqs = {
					...
					[JMod.EZ_RESOURCE_TYPES.EXPLOSIVES] = 200,
					[JMod.EZ_RESOURCE_TYPES.FISSILEMATERIAL] = 100
				},
				sizeScale = 1,
				category = "Explosives",
				craftingType = "toolbox",
			...
			["EZ Thermonuclear Bomb"] = {
				...
				craftingReqs = {
					...
					[JMod.EZ_RESOURCE_TYPES.FISSILEMATERIAL] = 600
				},
				sizeScale = 1.5,
				category = "Explosives",
				craftingType = "toolbox",
